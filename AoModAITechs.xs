...
group Apollo
{
	...
	createSimpleResearchPlan(techID, -1, cMilitaryEscrowID, 6);
	xsDisableSelf();
}
...
group Hathor
{
	...
	return;
	createSimpleResearchPlan(cTechMedjay, -1, cMilitaryEscrowID, 2);
    xsDisableSelf();
}
...
minInterval 23
{
	...
	return;
    createSimpleResearchPlan(cTechFocus, -1, cMilitaryEscrowID, 1);
    xsDisableSelf();
}
