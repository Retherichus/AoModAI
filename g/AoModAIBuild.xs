    ...
    inactive
{
    ...
    if ((gFarming == false) || (numFarmsNearMainBaseInR30 >= MoreFarms) || (numFarmsNearMainBaseInR30 >= 32) || (numFarmsNearMainBaseInR30 < 20) || (numVillagers < 20) || (numFarmsNearMainBaseInR30 > 24) && (aiGetWorldDifficulty() > cDifficultyHard))
    {
