    ...
    inactive
{
    ...
    //Don't get too many more than our human allies, stops after 25 min.
    ...
    inactive
{
    ...
    if ((gFarming == false) || (numFarmsNearMainBaseInR30 >= MoreFarms) || (numFarmsNearMainBaseInR30 >= 32) || (numFarmsNearMainBaseInR30 < 18) || (numVillagers < 20) || (numFarmsNearMainBaseInR30 > 24) && (aiGetWorldDifficulty() > cDifficultyHard))
    {
