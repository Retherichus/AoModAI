...
//Test end
   ...
   if ((xsGetTime() < 11*60*1000) || (xsGetTime() < 16*60*1000) && (numberInitialMainBaseSites >= 1))
      desiredGoldPlans = 1;
    ...
    inactive
{
    ...
    if ((kbGetAge() == cAge1) && (kbGetTechStatus(gAge2MinorGod) < cTechStatusResearching) || (unassigned < numPlansWanted))
        numPlansWanted = 1;
