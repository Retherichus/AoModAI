...
{   
    ...
    if ((woodGathererCount <= 0 ) && (kbGetAge() >= cAge1) || (woodGathererCount <= 1 ) && (kbGetAge() == cAge1) && (cMyCulture != cCultureAtlantean) && (cMyCulture != cCultureEgyptian)) //always some units on wood, unless there are less than 15 trees
    {
            woodGathererCount = 1;
    ...
    if (farmers > 0)
    {
        ...
        if (farmersAtMainBase > 0)
        {
            ...
            else
            {
                ...
                {
                    numFarmPlansWanted = numFarmPlansWanted + 1;  //1
                }
            }                
        }
        gFarming = true;
