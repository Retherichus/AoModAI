    ...
    inactive
{
    ...
    if ((aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, Building, true) > -1) ||(kbResourceGet(cResourceGold) < 600) ||
   ...
   if ((kbResourceGet(cResourceFood) > 1500) && (kbResourceGet(cResourceGold) > 1000) && (kbResourceGet(cResourceWood) > 100) && (kbResourceGet(cResourceFavor) > 15) && (cMyCulture != cCultureEgyptian) ||
   (kbResourceGet(cResourceFood) > 1500) && (kbResourceGet(cResourceGold) > 1000) && (kbResourceGet(cResourceFavor) > 15) && (cMyCulture == cCultureEgyptian))
   ...
   if (kbUnitQueryExecute(skyPassageQueryID) < 2)
   {
	  ...
	  if (cMyCulture == cCultureAtlantean)
	  aiPlanAddUnitType(remotePlanID, kbTechTreeGetUnitIDTypeByFunctionIndex(cUnitFunctionBuilder, 0), 1, 1, 1);
	  else aiPlanAddUnitType(remotePlanID, kbTechTreeGetUnitIDTypeByFunctionIndex(cUnitFunctionBuilder, 0), 1, 2, 3);
	  aiPlanSetActive(remotePlanID);
   }
}