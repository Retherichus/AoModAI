   ...
   active
{
    if (kbGetAge() > cAge3)
    {
		...
		if (cMyCulture == cCultureAtlantean)
		{
		kbUnitPickSetPreferenceFactor(gLateUPID, cUnitTypeTridentSoldier, 0.5+aiRandInt(4));
		kbUnitPickSetPreferenceFactor(gLateUPID, cUnitTypeArcherAtlantean, 0.6+aiRandInt(4));
