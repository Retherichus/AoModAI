...
{ 
    ...
    float favorSupply = kbResourceGet(cResourceFavor);
    if ((woodSupply < 400) || (favorSupply < 20) || (kbUnitCount(cMyID, cUnitTypeMinotaur, cUnitStateAlive) < 2))
        return;
    ...
    group techsGreekMinorGodAge2
{
    ...
    float woodSupply = kbResourceGet(cResourceWood);
    float favorSupply = kbResourceGet(cResourceFavor);
    if ((woodSupply < 600) || (favorSupply < 40) || (kbUnitCount(cMyID, cUnitTypeCentaur, cUnitStateAlive) < 2))
        return;    
