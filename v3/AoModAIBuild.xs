    ...
    minInterval 37 //starts in cAge3, activated in tradeWithCaravans
{
    ...
    if (marketPlanID >= 0)
    {
		...
		aiPlanSetVariableVector(marketPlanID, cBuildPlanInfluencePosition, 0, mainBaseLocation);
        aiPlanSetVariableFloat(marketPlanID, cBuildPlanInfluencePositionDistance, 0, 32.0);
